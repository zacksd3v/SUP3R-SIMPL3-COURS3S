...
// ZAMU GAJI KOMAI DA PARENT YAKE DA SHI HARMA MU QARA DA ABINDA PARENT BASHI DA SHI WA CHILD
...
export class Clothing extends Product {
  ...
  constructor(productDetails) {
    // BY DEFAULT CHILD CLASS YANA AMFANI DA PARENT CONTRUCTOR
    // AMMA IDAN MUKA ZO QARA WANI PROPERTY KO METHOD NB: DOLE
    // NE MUYI AMFANI DA SPECIAL METHOD CALLED super().
...
// SABODA INA SON LOOPING NA DUKA OBJECT DIN.
// SNN DUK BAYAN WANI LOOPIN 1 INA SON NAYI CREATING SABON OBJECT
// BEST SOLUTION SHINE MAP.
...
// -------------- BACKEND ------------
// IDAN MUKA ZAMU IYA LOADING & DISPLAY ALL
...
function loadingProducts() {
  ...
  xhr.addEventListener('load', () => {
    ...
    // WNN MA ZAN MAIDA SHI CLASS TA HANYAR
    // AMFANI DA .map() method.
