...
export default function RegisterScreen({ setIsRegisterPage }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // REDIRECT: Mayar da shi shafin Login nan take
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#007BFF', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 10, height: 55, justifyContent: 'center' },
